% pigfetch(SECTION) | User Commands
%
% "June 23 2024"
...
pigfetch - program to do something

# SYNOPSIS

**pigfetch** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pigfetch** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pigfetch** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pigfetch** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pigfetch. See **foo.conf**(5) for further details.
...
**pigfetch** provides some return codes, that can be used in scripts:
